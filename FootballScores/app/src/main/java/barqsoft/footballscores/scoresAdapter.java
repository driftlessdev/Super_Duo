...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        if(mHolder.match_id == detail_match_id)
        {
            ...
            share_button.setContentDescription(context.getString(R.string.cd_share_score,cursor.getString(COL_HOME),cursor.getString(COL_AWAY)));
            share_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v)
                {
                    ...
                    +mHolder.score.getText()+" "+mHolder.away_name.getText() + " ",context));
                }
            });
        }
        else
    ...
    public Intent createShareForecastIntent(String ShareText, Context context) {
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT, ShareText + context.getString(R.string.football_scores_hashtag));
        return shareIntent;
    }
